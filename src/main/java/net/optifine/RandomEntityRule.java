...
public class RandomEntityRule
{
    ...
    public boolean matches(IRandomEntity randomEntity)
    {
        ...
        else
        {
            ...
            if (this.colors != null && randomEntity instanceof RandomEntity)
            {
                RandomEntity randomentity1 = (RandomEntity)randomEntity;
                Entity entity1 = randomentity1.getEntity();
                DyeColor dyecolor = this.getEntityColor(entity1);
            ...
            {
                RandomEntity randomentity3 = (RandomEntity)randomEntity;
                Entity entity3 = randomentity3.getEntity();
                int j1 = this.getEntitySize(entity3);

                if (j1 >= 0 && !this.sizes.isInRange(j1))
                {
                    return false;
                }
            }
