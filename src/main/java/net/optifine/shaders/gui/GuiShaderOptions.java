...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    {
        super(new TextComponent(I18n.a("of.options.shaderOptionsTitle")));
    ...
    public void init()
    {
        ...
        this.addRenderableWidget(new GuiButtonOF(201, this.width / 2 - i1 - 20, this.height / 6 + 168 + 11, i1, j1, I18n.a("controls.reset")));
        this.addRenderableWidget(new GuiButtonOF(200, this.width / 2 + 20, this.height / 6 + 168 + 11, i1, j1, I18n.a("gui.done")));
    }
