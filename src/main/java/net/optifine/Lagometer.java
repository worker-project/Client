            ...
            if (gameSettings.ofLagometer || gameSettings.renderFpsChart)
            {
                ...
                for (int l = 0; l < timesFrame.length; ++l)
                {
                    ...
                    else
                    {
                        ...
                        f -= (float)renderTime(l, timesServer[l], i1 / 2, i1 / 2, i1 / 2, f, bufferbuilder);
                        f -= (float)renderTime(l, timesTerrain[l], 0, i1, 0, f, bufferbuilder);
                        f -= (float)renderTime(l, timesVisibility[l], i1, i1, 0, f, bufferbuilder);
                        f -= (float)renderTime(l, timesChunkUpdate[l], i1, 0, 0, f, bufferbuilder);
                        f -= (float)renderTime(l, timesChunkUpload[l], i1, 0, i1, f, bufferbuilder);
                        f -= (float)renderTime(l, timesScheduledExecutables[l], 0, 0, i1, f, bufferbuilder);
                ...
                mc.font.draw(matrixStackIn, " " + MemoryMonitor.getGcRateMb() + " MB/s", (float)k2, (float)l2, j2);
