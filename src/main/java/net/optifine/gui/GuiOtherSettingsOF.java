...
public class GuiOtherSettingsOF extends GuiScreenOF
{
    ...
    public void init()
    {
        ...
        Option[] aoption = new Option[] {Option.LAGOMETER, Option.PROFILER, Option.SHOW_FPS, Option.ADVANCED_TOOLTIPS, Option.WEATHER, Option.TIME, Option.USE_FULLSCREEN, Option.AUTOSAVE_TICKS, Option.SCREENSHOT_SIZE, Option.SHOW_GL_ERRORS, Option.TELEMETRY, null, option, null};
