...
public class ClientboundPlayerAbilitiesPacket implements Packet<ClientGamePacketListener>
{
    ...
    public ClientboundPlayerAbilitiesPacket(Abilities pBuffer)
    {
        this.invulnerable = pBuffer.invulnerable;
        this.isFlying = pBuffer.flying;
        this.canFly = pBuffer.mayfly;
        this.instabuild = pBuffer.instabuild;
        this.flyingSpeed = pBuffer.getFlyingSpeed();
        this.walkingSpeed = pBuffer.getWalkingSpeed();
    }
