...
public class Style
{
    ...
    public Style withColor(@Nullable TextColor pRgb)
    {
        return new Style(pRgb, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent, this.insertion, this.font);
    }

    public Style withColor(@Nullable ChatFormatting pRgb)
    {
        return this.withColor(pRgb != null ? TextColor.fromLegacyFormat(pRgb) : null);
    }
    ...
    public Style a(ChatFormatting... p_131153_)
    {
        TextColor textcolor = this.color;
        Boolean obool = this.bold;
        Boolean obool1 = this.italic;
