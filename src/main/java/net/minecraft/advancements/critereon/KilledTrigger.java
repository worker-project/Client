...
public class KilledTrigger extends SimpleCriterionTrigger<KilledTrigger.TriggerInstance>
{
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate pEntityPredicateBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), DamageSourcePredicate.ANY);
        }
        ...
        public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate pEntityPredicateBuilder, DamageSourcePredicate pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), pKillingBlowBuilder);
        }

        public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate.Builder pEntityPredicateBuilder, DamageSourcePredicate pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder.build()), pKillingBlowBuilder);
        }

        public static KilledTrigger.TriggerInstance playerKilledEntity(EntityPredicate pEntityPredicateBuilder, DamageSourcePredicate.Builder pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.PLAYER_KILLED_ENTITY.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), pKillingBlowBuilder.build());
        }
        ...
        public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate pEntityPredicateBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), DamageSourcePredicate.ANY);
        }
        ...
        public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate pEntityPredicateBuilder, DamageSourcePredicate pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), pKillingBlowBuilder);
        }

        public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate.Builder pEntityPredicateBuilder, DamageSourcePredicate pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder.build()), pKillingBlowBuilder);
        }

        public static KilledTrigger.TriggerInstance entityKilledPlayer(EntityPredicate pEntityPredicateBuilder, DamageSourcePredicate.Builder pKillingBlowBuilder)
        {
            return new KilledTrigger.TriggerInstance(CriteriaTriggers.ENTITY_KILLED_PLAYER.id, EntityPredicate.Composite.ANY, EntityPredicate.Composite.wrap(pEntityPredicateBuilder), pKillingBlowBuilder.build());
        }
