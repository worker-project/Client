...
public class PlayerHurtEntityTrigger extends SimpleCriterionTrigger<PlayerHurtEntityTrigger.TriggerInstance>
{
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static PlayerHurtEntityTrigger.TriggerInstance playerHurtEntity(DamagePredicate pDamageBuilder)
        {
            return new PlayerHurtEntityTrigger.TriggerInstance(EntityPredicate.Composite.ANY, pDamageBuilder, EntityPredicate.Composite.ANY);
        }
        ...
        public static PlayerHurtEntityTrigger.TriggerInstance playerHurtEntity(EntityPredicate pDamageBuilder)
        {
            return new PlayerHurtEntityTrigger.TriggerInstance(EntityPredicate.Composite.ANY, DamagePredicate.ANY, EntityPredicate.Composite.wrap(pDamageBuilder));
        }

        public static PlayerHurtEntityTrigger.TriggerInstance playerHurtEntity(DamagePredicate pDamageBuilder, EntityPredicate pEntity)
        {
            return new PlayerHurtEntityTrigger.TriggerInstance(EntityPredicate.Composite.ANY, pDamageBuilder, EntityPredicate.Composite.wrap(pEntity));
        }
