...
public class LocationPredicate
{
    ...
    {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, pBiome, (ResourceKey < ConfiguredStructureFeature <? , ? >>)null, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }

    public static LocationPredicate inDimension(ResourceKey<Level> pDimension)
    {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, (ResourceKey < ConfiguredStructureFeature <? , ? >>)null, pDimension, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }
    ...
    public static class Builder
    {
        ...
        public LocationPredicate.Builder setFeature(@Nullable ResourceKey < ConfiguredStructureFeature <? , ? >> pFeature)
        {
            this.feature = pFeature;
            return this;
        }
