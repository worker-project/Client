...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>>
{
    ...
    public void accept(Consumer<Advancement> p_123998_)
    {
        ...
        Advancement advancement6 = Advancement.Builder.advancement().parent(advancement5).requirements(RequirementsStrategy.OR).addCriterion(Registry.ITEM.getKey(Items.AXOLOTL_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().a(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.title"), new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_123998_, "husbandry/axolotl_in_a_bucket");
    ...
    private Advancement.Builder addFishBuckets(Advancement.Builder pBuilder)
    {
        ...
        {
            pBuilder.addCriterion(Registry.ITEM.getKey(item).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().a(item).build()));
        }
    ...
    private Advancement.Builder addFish(Advancement.Builder pBuilder)
    {
        for (Item item : FISH)
        {
            pBuilder.addCriterion(Registry.ITEM.getKey(item).getPath(), FishingRodHookedTrigger.TriggerInstance.fishedItem(ItemPredicate.ANY, EntityPredicate.ANY, ItemPredicate.Builder.item().a(item).build()));
        }
