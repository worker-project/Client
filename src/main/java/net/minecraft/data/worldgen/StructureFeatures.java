...
public class StructureFeatures
{
    ...
    public static final Holder < ConfiguredStructureFeature <? , ? >> SWAMP_HUT = register(BuiltinStructures.SWAMP_HUT, StructureFeature.SWAMP_HUT.configured(NoneFeatureConfiguration.INSTANCE, BiomeTags.HAS_SWAMP_HUT, Map.of(MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.a(new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1, 1))), MobCategory.CREATURE, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.a(new MobSpawnSettings.SpawnerData(EntityType.CAT, 1, 1, 1))))));
    ...
    private static <FC extends FeatureConfiguration, F extends StructureFeature<FC>> Holder < ConfiguredStructureFeature <? , ? >> register(ResourceKey < ConfiguredStructureFeature <? , ? >> pId, ConfiguredStructureFeature<FC, F> pConfiguredStructureFeature)
    {
        return BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, pId, pConfiguredStructureFeature);
    }
}
