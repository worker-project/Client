...
public class AquaticFeatures
{
    ...
    public static final Holder < ConfiguredFeature < SimpleRandomFeatureConfiguration, ? >> WARM_OCEAN_VEGETATION = FeatureUtils.register("warm_ocean_vegetation", Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfiguration(HolderSet.a(PlacementUtils.a(Feature.CORAL_TREE, FeatureConfiguration.NONE), PlacementUtils.a(Feature.CORAL_CLAW, FeatureConfiguration.NONE), PlacementUtils.a(Feature.CORAL_MUSHROOM, FeatureConfiguration.NONE))));
}
