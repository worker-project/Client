...
public class PlacementUtils
{
    ...
    public static Holder<PlacedFeature> a(String p_206514_, Holder <? extends ConfiguredFeature <? , ? >> p_206515_, PlacementModifier... p_206516_)
    {
    ...
    public static Holder<PlacedFeature> a(Holder <? extends ConfiguredFeature <? , ? >> p_206507_, PlacementModifier... p_206508_)
    {
        return Holder.direct(new PlacedFeature(Holder.hackyErase(p_206507_), List.of(p_206508_)));
    }

    public static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<PlacedFeature> a(F p_206503_, FC p_206504_, PlacementModifier... p_206505_)
    {
        return a(Holder.direct(new ConfiguredFeature<>(p_206503_, p_206504_)), p_206505_);
    }
    ...
    {
        return a(p_206499_, p_206500_, BlockPredicateFilter.forPredicate(p_206501_));
    }
}
