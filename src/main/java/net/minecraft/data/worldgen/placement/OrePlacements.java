...
public class OrePlacements
{
    ...
    public static final Holder<PlacedFeature> ORE_ANCIENT_DEBRIS_LARGE = PlacementUtils.a("ore_ancient_debris_large", OreFeatures.ORE_ANCIENT_DEBRIS_LARGE, InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.absolute(8), VerticalAnchor.absolute(24)), BiomeFilter.biome());
    public static final Holder<PlacedFeature> ORE_ANCIENT_DEBRIS_SMALL = PlacementUtils.a("ore_debris_small", OreFeatures.ORE_ANCIENT_DEBRIS_SMALL, InSquarePlacement.spread(), PlacementUtils.RANGE_8_8, BiomeFilter.biome());
