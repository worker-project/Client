...
public class ItemModelGenerators
{
    ...
    private void generateFlatItem(Item pItem, Item pModelLocationSuffix, ModelTemplate pModelTemplate)
    {
        pModelTemplate.create(ModelLocationUtils.getModelLocation(pItem), TextureMapping.layer0(pModelLocationSuffix), this.output);
    }
