...
public class TextureMapping
{
    ...
    {
        ResourceLocation resourcelocation = getBlockTexture(pAllTextureLocation);
        return cube(resourcelocation);
    }

    public static TextureMapping defaultTexture(Block pTextureLocation)
    {
        ResourceLocation resourcelocation = getBlockTexture(pTextureLocation);
    ...
    {
        return singleSlot(TextureSlot.CROSS, getBlockTexture(pCrossTextureLocation));
    }
    ...
    {
        return singleSlot(TextureSlot.PLANT, getBlockTexture(pPlantTextureLocation));
    }
    ...
    {
        return singleSlot(TextureSlot.RAIL, getBlockTexture(pRailTextureLocation));
    }
    ...
    {
        return singleSlot(TextureSlot.WOOL, getBlockTexture(pWoolTextureLocation));
    }
    ...
    {
        return (new TextureMapping()).put(TextureSlot.PARTICLE, getBlockTexture(pTextureLocation));
    }
    ...
    {
        return (new TextureMapping()).put(TextureSlot.TORCH, getBlockTexture(pTorchTextureLocation));
    }
    ...
    {
        return (new TextureMapping()).put(TextureSlot.LAYER0, getItemTexture(pLayerZeroTextureLocation));
    }

    public static TextureMapping layer0(Block pLayerZeroTextureLocation)
    {
        return (new TextureMapping()).put(TextureSlot.LAYER0, getBlockTexture(pLayerZeroTextureLocation));
    }
