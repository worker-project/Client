...
public final class Selector
{
    ...
    public Selector extend(Property.Value<?> pSelector)
    {
        return new Selector(ImmutableList. < Property.Value<? >> builder().addAll(this.values).add(pSelector).build());
    }
    ...
    public static Selector a(Property.Value<?>... p_125491_)
    {
