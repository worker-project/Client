...
default void suggestRegistryElements(Registry<?> p_212336_, SharedSuggestionProvider.ElementSuggestionType p_212337_, SuggestionsBuilder p_212338_)
    ...
    static CompletableFuture<Suggestions> suggestResource(Stream<ResourceLocation> pResources, SuggestionsBuilder pBuilder)
    {
        return suggestResource(pResources::iterator, pBuilder);
    }
    ...
    static CompletableFuture<Suggestions> a(String[] p_82968_, SuggestionsBuilder p_82969_)
    {
