...
public class CommandFunction
{
    ...
    public static class CacheableFunction
    {
        ...
        public CacheableFunction(@Nullable ResourceLocation pFunction)
        {
            this.id = pFunction;
        }
    ...
    public static class CommandEntry implements CommandFunction.Entry
    {
        ...
        {
            return pFunctionManager.getDispatcher().execute(new ParseResults<>(this.parse.getContext().withSource(pSource), this.parse.getReader(), this.parse.getExceptions()));
        }
