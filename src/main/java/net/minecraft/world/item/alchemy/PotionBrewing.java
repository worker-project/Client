...
public class PotionBrewing
{
    ...
    private static void addContainerRecipe(Item pFrom, Item pIngredient, Item pTo)
    {
        ...
        {
            CONTAINER_MIXES.add(new PotionBrewing.Mix<>(pFrom, Ingredient.a(pIngredient), pTo));
        }
    }
    ...
    private static void addContainer(Item pContainer)
    {
        ...
        {
            ALLOWED_CONTAINERS.add(Ingredient.a(pContainer));
        }
    }

    private static void addMix(Potion pPotionEntry, Item pPotionIngredient, Potion pPotionResult)
    {
        POTION_MIXES.add(new PotionBrewing.Mix<>(pPotionEntry, Ingredient.a(pPotionIngredient), pPotionResult));
    }
