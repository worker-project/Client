        ...
        if (this.type == EntityType.TROPICAL_FISH)
        {
            ...
            if (compoundtag != null && compoundtag.contains("BucketVariantTag", 3))
            {
                ...
                for (int j = 0; j < TropicalFish.COMMON_VARIANTS.length; ++j)
                {
                    ...
                    {
                        pTooltipComponents.add((new TranslatableComponent(TropicalFish.getPredefinedName(j))).a(achatformatting));
                        return;
                    }
                }

                pTooltipComponents.add((new TranslatableComponent(TropicalFish.getFishTypeName(i))).a(achatformatting));
                ...
                mutablecomponent.a(achatformatting);
