...
public class ShapedRecipe implements CraftingRecipe
{
    ...
    static NonNullList<Ingredient> a(String[] p_44203_, Map<String, Ingredient> p_44204_, int p_44205_, int p_44206_)
    {
    ...
    @VisibleForTesting
    static String[] a(String... p_44187_)
    {
    ...
    public static class Serializer implements RecipeSerializer<ShapedRecipe>
    {
        public ShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson)
        {
            ...
            String[] astring = ShapedRecipe.a(ShapedRecipe.patternFromJson(GsonHelper.getAsJsonArray(pJson, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = ShapedRecipe.a(astring, map, i, j);
