...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable
{
    ...
    public void updateChunkStatus(ChunkPos pPos, Visibility pStatus)
    {
        ...
        {
            this.chunkVisibility.put(i, pStatus);
        ...
        {
            Visibility visibility = p_157545_.updateChunkStatus(pStatus);
        ...
        this.sectionStorage.getAllChunksWithExistingSections().forEach((long p_157517_) ->
        {
            ...
            this.sectionStorage.getExistingSectionPositionsInChunk(p_157517_).forEach((p_157521_) -> {
                ...
                if (entitysection != null)
                {
                    try
                    {
                        csvoutput.a(SectionPos.x(p_157521_), SectionPos.y(p_157521_), SectionPos.z(p_157521_), entitysection.getStatus(), persistententitysectionmanager$chunkloadstatus, entitysection.size());
                    }
