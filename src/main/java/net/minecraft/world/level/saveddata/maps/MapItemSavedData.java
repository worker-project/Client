...
public class MapItemSavedData extends SavedData
{
    ...
    public static MapItemSavedData createFresh(double pX, double p_164782_, byte pZ, boolean p_164784_, boolean pScale, ResourceKey<Level> pTrackingPosition)
    {
        int i = 128 * (1 << pZ);
        ...
        int l = j * i + i / 2 - 64;
        int i1 = k * i + i / 2 - 64;
        return new MapItemSavedData(l, i1, pZ, p_164784_, pScale, false, pTrackingPosition);
    }
    ...
    public CompoundTag save(CompoundTag pCompound)
    {
        ...
        pCompound.a("colors", this.colors);
    ...
    private void addDecoration(MapDecoration.Type pType, @Nullable LevelAccessor pLevel, String pDecorationName, double pLevelX, double p_77942_, double pLevelZ, @Nullable Component p_77944_)
    {
        ...
        {
            pLevelZ += pLevelZ < 0.0D ? -8.0D : 8.0D;
