...
public final class OverworldBiomeBuilder
{
    ...
    {
        return a(p_187210_, this.erosions);
    }

    public String getDebugStringForTemperature(double p_187221_)
    {
        return a(p_187221_, this.temperatures);
    }

    public String getDebugStringForHumidity(double p_187232_)
    {
        return a(p_187232_, this.humidities);
    }

    private static String a(double p_187158_, Climate.Parameter[] p_187159_)
    {
