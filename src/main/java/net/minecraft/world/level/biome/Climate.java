...
public class Climate
{
    ...
    public static class ParameterList<T>
    {
        ...
        {
            return this.findValueIndex(p_186852_, Climate.RTree.Node::a);
        }
    ...
    protected static final class RTree<T>
    {
        ...
        private static long a(Climate.Parameter[] p_186943_)
        {
            long i = 0L;
        ...
        public T search(Climate.TargetPoint p_186931_, Climate.DistanceMetric<T> p_186932_)
        {
            ...
            Climate.RTree.Leaf<T> leaf = this.root.a(along, this.lastResult.get(), p_186932_);
        ...
        static final class Leaf<T> extends Climate.RTree.Node<T>
        {
            ...
            protected Climate.RTree.Leaf<T> a(long[] p_186953_, @Nullable Climate.RTree.Leaf<T> p_186954_, Climate.DistanceMetric<T> p_186955_)
            {
                return this;
            }
        }
        ...
        abstract static class Node<T>
        {
            ...
            protected abstract Climate.RTree.Leaf<T> a(long[] p_186961_, @Nullable Climate.RTree.Leaf<T> p_186962_, Climate.DistanceMetric<T> p_186963_);

            protected long a(long[] p_186960_)
            {
                long i = 0L;
        ...
        static final class SubTree<T> extends Climate.RTree.Node<T>
        {
            ...
            protected Climate.RTree.Leaf<T> a(long[] p_186972_, @Nullable Climate.RTree.Leaf<T> p_186973_, Climate.DistanceMetric<T> p_186974_)
            {
                ...
                for (Climate.RTree.Node<T> node : this.children)
                {
                    ...
                    if (i > j)
                    {
                        Climate.RTree.Leaf<T> leaf1 = node.a(p_186972_, leaf, p_186974_);
