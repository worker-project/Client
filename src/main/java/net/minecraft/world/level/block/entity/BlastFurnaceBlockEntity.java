...
{
    public BlastFurnaceBlockEntity(BlockPos pWorldPosition, BlockState pBlockState)
    {
        super(BlockEntityType.BLAST_FURNACE, pWorldPosition, pBlockState, RecipeType.BLASTING);
    }
