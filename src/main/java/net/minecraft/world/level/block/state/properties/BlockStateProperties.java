...
public class BlockStateProperties
{
    ...
    public static final EnumProperty<Direction.Axis> HORIZONTAL_AXIS = EnumProperty.a("axis", Direction.Axis.class, Direction.Axis.X, Direction.Axis.Z);
    ...
    public static final DirectionProperty FACING = DirectionProperty.a("facing", Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN);
    ...
    public static final DirectionProperty VERTICAL_DIRECTION = DirectionProperty.a("vertical_direction", Direction.UP, Direction.DOWN);
