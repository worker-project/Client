...
public class SimplexNoise
{
    ...
    protected static double a(int[] p_75480_, double p_75481_, double p_75482_, double p_75483_)
    {
        return (double)p_75480_[0] * p_75481_ + (double)p_75480_[1] * p_75482_ + (double)p_75480_[2] * p_75483_;
    }

    private double getCornerNoise3D(int pGradientIndex, double pX, double p_75476_, double pY, double p_75478_)
    {
        ...
        {
            d1 *= d1;
            d0 = d1 * d1 * a(GRADIENT[pGradientIndex], pX, p_75476_, pY);
        }
