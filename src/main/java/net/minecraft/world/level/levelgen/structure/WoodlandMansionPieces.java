...
{
    public static void generateMansion(StructureManager pStructureManager, BlockPos pPos, Rotation pRotation, List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, Random pRandom)
    {
        WoodlandMansionPieces.MansionGrid woodlandmansionpieces$mansiongrid = new WoodlandMansionPieces.MansionGrid(pRandom);
        WoodlandMansionPieces.MansionPiecePlacer woodlandmansionpieces$mansionpieceplacer = new WoodlandMansionPieces.MansionPiecePlacer(pStructureManager, pRandom);
        woodlandmansionpieces$mansionpieceplacer.createMansion(pPos, pRotation, pPieces, woodlandmansionpieces$mansiongrid);
    }

    public static void a(String[] p_163677_)
    {
    ...
    static class MansionGrid
    {
        ...
        public MansionGrid(Random pRandom)
        {
            this.random = pRandom;
            int i = 11;
            this.entranceX = 7;
    ...
    static class MansionPiecePlacer
    {
        ...
        public MansionPiecePlacer(StructureManager pStructureManager, Random pRandom)
        {
                ...
                for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.height; ++i1)
                {
                    for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.width; ++j1)
                    {
                        if (woodlandmansionpieces$simplegrid3.get(j1, i1) == 1)
                        {
                            ...
                            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "corridor_floor", blockpos1, pRotation));

                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 - 1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1, i1 - 1) & 8388608) == 8388608)
                            {
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "carpet_north", blockpos1.relative(pRotation.rotate(Direction.EAST), 1).above(), pRotation));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1 + 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 + 1, i1) & 8388608) == 8388608)
                            {
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "carpet_east", blockpos1.relative(pRotation.rotate(Direction.SOUTH), 1).relative(pRotation.rotate(Direction.EAST), 5).above(), pRotation));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 + 1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1, i1 + 1) & 8388608) == 8388608)
                            {
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, s, blockpos1.relative(pRotation.rotate(Direction.SOUTH), 5).relative(pRotation.rotate(Direction.WEST), 1), pRotation));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1 - 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 - 1, i1) & 8388608) == 8388608)
                            {
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, s1, blockpos1.relative(pRotation.rotate(Direction.WEST), 1).relative(pRotation.rotate(Direction.NORTH), 1), pRotation));
                            }
                        }
                    }
                }
                ...
                for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.height; ++k1)
                {
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1)
                    {
                        ...
                        if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1)
                        {
                            ...
                            {
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction1 == Direction.WEST ? s3 : s2, blockpos3, pRotation));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1)
                            {
                                ...
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction1 == Direction.EAST ? s3 : s2, blockpos2, pRotation));
                            }
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !pGrid.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2))
                            {
                                ...
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction1 == Direction.SOUTH ? s3 : s2, blockpos4, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1, k1 - 1) == 1 && !flag1)
                            {
                                ...
                                pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, direction1 == Direction.NORTH ? s3 : s2, blockpos5, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                            }
        ...
        private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, WoodlandMansionPieces.PlacementData pData)
        {
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "entrance", pData.position.relative(direction, 9), pData.rotation));
        ...
        {
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pData.wallType, pData.position.relative(pData.rotation.rotate(Direction.EAST), 7), pData.rotation));
        ...
        private void traverseTurn(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, WoodlandMansionPieces.PlacementData pData)
        {
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "wall_corner", pData.position, pData.rotation));
        ...
        private void addRoom1x1(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, BlockPos pPos, Rotation pRotation, Direction pDirection, WoodlandMansionPieces.FloorRoomCollection pFloorRooms)
        {
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, s, blockpos1, rotation));
        }
        ...
        private void addRoom2x2Secret(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, BlockPos pPos, Rotation pRotation, WoodlandMansionPieces.FloorRoomCollection pFloorRooms)
        {
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get2x2Secret(this.random), blockpos, pRotation, Mirror.NONE));
        }
    }
    ...
    {
        public WoodlandMansionPiece(StructureManager pStructureManager, String pName, BlockPos pPos, Rotation pRotation)
        {
            this(pStructureManager, pName, pPos, pRotation, Mirror.NONE);
        }

        public WoodlandMansionPiece(StructureManager pStructureManager, String pName, BlockPos pPos, Rotation pRotation, Mirror pMirror)
        {
            super(StructurePieceType.WOODLAND_MANSION_PIECE, 0, pStructureManager, makeLocation(pName), pName, makeSettings(pMirror, pRotation), pPos);
        }
