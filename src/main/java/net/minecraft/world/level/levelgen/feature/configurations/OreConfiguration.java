...
public class OreConfiguration implements FeatureConfiguration
{
    ...
    public OreConfiguration(List<OreConfiguration.TargetBlockState> pTarget, int pState, float pSize)
    {
        this.size = pState;
        this.targetStates = pTarget;
        this.discardChanceOnAirExposure = pSize;
    }
