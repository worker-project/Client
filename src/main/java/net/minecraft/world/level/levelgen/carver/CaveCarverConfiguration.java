...
public class CaveCarverConfiguration extends CarverConfiguration
{
    ...
    public CaveCarverConfiguration(float pProbability, HeightProvider pY, FloatProvider pYScale, VerticalAnchor pLavaLevel, CarverDebugSettings pAquifersEnabled, FloatProvider pHorizontalRadiusMultiplier, FloatProvider pVerticalRadiusMultiplier, FloatProvider pFloorLevel)
    {
        super(pProbability, pY, pYScale, pLavaLevel, pAquifersEnabled);
    ...
    public CaveCarverConfiguration(float pProbability, HeightProvider pY, FloatProvider pYScale, VerticalAnchor pLavaLevel, boolean pAquifersEnabled, FloatProvider pHorizontalRadiusMultiplier, FloatProvider pVerticalRadiusMultiplier, FloatProvider pFloorLevel)
    {
        this(pProbability, pY, pYScale, pLavaLevel, CarverDebugSettings.DEFAULT, pHorizontalRadiusMultiplier, pVerticalRadiusMultiplier, pFloorLevel);
    }
