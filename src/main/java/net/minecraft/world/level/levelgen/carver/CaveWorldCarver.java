...
public class CaveWorldCarver extends WorldCarver<CaveCarverConfiguration>
{
    ...
    private static boolean shouldSkip(double pRelative, double p_159197_, double pRelativeY, double p_159199_)
    {
        ...
        {
            return pRelative * pRelative + p_159197_ * p_159197_ + pRelativeY * pRelativeY >= 1.0D;
        }
    }
}
