...
public class SequentialEntry extends CompositeEntryBase
{
    ...
    protected ComposableEntryContainer a(ComposableEntryContainer[] p_79816_)
    {
    ...
    public static SequentialEntry.Builder a(LootPoolEntryContainer.Builder<?>... p_165153_)
    {
