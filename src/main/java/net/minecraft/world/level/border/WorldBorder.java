...
public class WorldBorder
{
    ...
    public boolean isWithinBounds(double pX, double p_156095_)
    {
        return pX > this.getMinX() && pX < this.getMaxX() && p_156095_ > this.getMinZ() && p_156095_ < this.getMaxZ();
    }
    ...
    public static class Settings
    {
        ...
        Settings(double pCenterX, double p_62012_, double pCenterZ, double p_62014_, int pDamagePerBlock, int p_62016_, double pSafeZone, long p_62018_, double pWarningBlocks)
        {
            this.centerX = pCenterX;
            this.centerZ = p_62012_;
            this.damagePerBlock = pCenterZ;
            this.safeZone = p_62014_;
            this.warningBlocks = pDamagePerBlock;
            this.warningTime = p_62016_;
            this.size = pSafeZone;
            this.sizeLerpTime = p_62018_;
            this.sizeLerpTarget = pWarningBlocks;
        }
