...
public class RandomStrollGoal extends Goal
{
    ...
    public RandomStrollGoal(PathfinderMob pMob, double pSpeedModifier, int p_25739_)
    {
        this(pMob, pSpeedModifier, p_25739_, true);
    }

    public RandomStrollGoal(PathfinderMob pMob, double pSpeedModifier, int p_25743_, boolean pInterval)
    {
        this.mob = pMob;
        this.speedModifier = pSpeedModifier;
        this.interval = p_25743_;
        this.checkNoActionTime = pInterval;
