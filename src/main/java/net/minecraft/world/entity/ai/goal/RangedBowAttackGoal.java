...
public class RangedBowAttackGoal<T extends Monster & RangedAttackMob> extends Goal
{
    ...
    public RangedBowAttackGoal(T pMob, double pSpeedModifier, int p_25794_, float pAttackIntervalMin)
    {
        this.mob = pMob;
        this.speedModifier = pSpeedModifier;
        this.attackIntervalMin = p_25794_;
        this.attackRadiusSqr = pAttackIntervalMin * pAttackIntervalMin;
