...
public abstract class MoveToBlockGoal extends Goal
{
    ...
    public MoveToBlockGoal(PathfinderMob pMob, double pSpeedModifier, int p_25611_)
    {
        this(pMob, pSpeedModifier, p_25611_, 1);
    }

    public MoveToBlockGoal(PathfinderMob pMob, double pSpeedModifier, int p_25615_, int pSearchRange)
    {
        this.mob = pMob;
        this.speedModifier = pSpeedModifier;
        this.searchRange = p_25615_;
        this.verticalSearchStart = 0;
        this.verticalSearchRange = pSearchRange;
