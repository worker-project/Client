...
public class MoveThroughVillageGoal extends Goal
{
    ...
    public MoveThroughVillageGoal(PathfinderMob pMob, double pSpeedModifier, boolean p_25584_, int pOnlyAtNight, BooleanSupplier pDistanceToPoi)
    {
        this.mob = pMob;
        this.speedModifier = pSpeedModifier;
        this.onlyAtNight = p_25584_;
        this.distanceToPoi = pOnlyAtNight;
        this.canDealWithDoors = pDistanceToPoi;
