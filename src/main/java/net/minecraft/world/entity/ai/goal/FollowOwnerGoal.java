...
public class FollowOwnerGoal extends Goal
{
    ...
    public FollowOwnerGoal(TamableAnimal pTamable, double pSpeedModifier, float p_25296_, float pStartDistance, boolean pStopDistance)
    {
        ...
        this.stopDistance = pStartDistance;
        this.canFly = pStopDistance;
