...
public class Pig extends Animal implements ItemSteerable, Saddleable
{
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.a(Items.CARROT, Items.POTATO, Items.BEETROOT);
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.2D, Ingredient.a(Items.CARROT_ON_A_STICK), false));
