...
public class Panda extends Animal
{
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.0D, Ingredient.a(Blocks.BAMBOO.asItem()), false));
        ...
        this.targetSelector.addGoal(1, (new Panda.PandaHurtByTargetGoal(this)).a(new Class[0]));
    }
