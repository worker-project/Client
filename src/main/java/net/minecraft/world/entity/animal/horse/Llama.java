...
public class Llama extends AbstractChestedHorse implements RangedAttackMob
{
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.a(Items.WHEAT, Blocks.HAY_BLOCK.asItem());
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(5, new TemptGoal(this, 1.25D, Ingredient.a(Items.HAY_BLOCK), false));
