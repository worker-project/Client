...
public class Rabbit extends Animal
{
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0D, Ingredient.a(Items.CARROT, Items.GOLDEN_CARROT, Blocks.DANDELION), false));
    ...
    public void setRabbitType(int pRabbitTypeId)
    {
        if (pRabbitTypeId == 99)
        {
            ...
            this.targetSelector.addGoal(1, (new HurtByTargetGoal(this)).a());
