...
public class VillagerTrades
{
    ...
    static class ItemsForEmeralds implements VillagerTrades.ItemListing
    {
        ...
        public ItemsForEmeralds(Block pItem, int pEmeraldCost, int pNumberOfItems, int pMaxUses, int pVillagerXp)
        {
        ...
        public ItemsForEmeralds(ItemStack pItem, int pEmeraldCost, int pNumberOfItems, int pMaxUses, int pVillagerXp)
        {
            this(pItem, pEmeraldCost, pNumberOfItems, pMaxUses, pVillagerXp, 0.05F);
        }
