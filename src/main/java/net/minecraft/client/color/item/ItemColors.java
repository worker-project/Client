...
public class ItemColors
{
    ...
    public static ItemColors createDefault(BlockColors pColors)
    {
        ...
        itemcolors.a((p_92708_, p_92709_) ->
        {
        ...
        itemcolors.a((p_92705_, p_92706_) ->
        {
        ...
        itemcolors.a((p_92699_, p_92700_) ->
        {
        ...
        {
            itemcolors.a((p_92681_, p_92682_) ->
            {
        ...
        itemcolors.a((p_92696_, p_92697_) ->
        {
            return p_92697_ == 0 ? PotionUtils.getColor(p_92696_) : -1;
        }, Items.TIPPED_ARROW);
        itemcolors.a((p_92693_, p_92694_) ->
        {
