...
public class Checkbox extends AbstractButton
{
    ...
    public void updateNarration(NarrationElementOutput pNarrationElementOutput)
    {
        ...
        if (this.active)
        {
            if (this.isFocused())
            {
                pNarrationElementOutput.add(NarratedElementType.USAGE, new TranslatableComponent("narration.checkbox.usage.focused"));
            }
            else
            {
                pNarrationElementOutput.add(NarratedElementType.USAGE, new TranslatableComponent("narration.checkbox.usage.hovered"));
            }
        }
    }
