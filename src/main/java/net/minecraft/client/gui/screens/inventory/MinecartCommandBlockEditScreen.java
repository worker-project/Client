...
public class MinecartCommandBlockEditScreen extends AbstractCommandBlockEditScreen
{
    ...
    {
        if (pCommandBlock instanceof MinecartCommandBlock.MinecartCommandBase)
        {
            MinecartCommandBlock.MinecartCommandBase minecartcommandblock$minecartcommandbase = (MinecartCommandBlock.MinecartCommandBase)pCommandBlock;
