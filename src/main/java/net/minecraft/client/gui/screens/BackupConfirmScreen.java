...
public class BackupConfirmScreen extends Screen
{
    ...
    public BackupConfirmScreen(@Nullable Screen pLastScreen, BackupConfirmScreen.Listener pListener, Component pTitle, Component pDescription, boolean pPromptForCacheErase)
    {
        super(pTitle);
