...
public class EditGameRulesScreen extends Screen
{
    ...
    public class RuleList extends ContainerObjectSelectionList<EditGameRulesScreen.RuleEntry>
    {
        public RuleList(final GameRules p_101203_)
        {
            ...
            {
                this.addEntry(EditGameRulesScreen.this.new CategoryRuleEntry((new TranslatableComponent(p_101210_.getKey().getDescriptionId())).a(new ChatFormatting[]{ChatFormatting.BOLD, ChatFormatting.YELLOW})));
