...
public class ShareToLanScreen extends Screen
{
    ...
    protected void init()
    {
        this.addRenderableWidget(CycleButton.builder(GameType::getShortDisplayName).a(GameType.SURVIVAL, GameType.SPECTATOR, GameType.CREATIVE, GameType.ADVENTURE).withInitialValue(this.gameMode).create(this.width / 2 - 155, 100, 150, 20, GAME_MODE_LABEL, (p_169429_, p_169430_) ->
        {
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        drawCenteredString(pPoseStack, this.font, INFO_TEXT, this.width / 2, 82, 16777215);
