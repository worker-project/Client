...
public class StructureBlockEditScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.mirrorButton = this.addRenderableWidget(CycleButton.builder(Mirror::symbol).a(Mirror.values()).displayOnlyValue().withInitialValue(this.initialMirror).create(this.width / 2 - 20, 185, 40, 20, new TextComponent("MIRROR"), (p_169843_, p_169844_) ->
        {
