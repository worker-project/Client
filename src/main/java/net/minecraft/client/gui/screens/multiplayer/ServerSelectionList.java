...
public class ServerSelectionList extends ObjectSelectionList<ServerSelectionList.Entry> {
    ...
    public final ServerSelectionList.OnlineServerEntry HYPIXEL;
    ...
    public ServerSelectionList(JoinMultiplayerScreen pScreen, Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1, int pItemHeight) {
        ...
        this.screen = pScreen;
        this.HYPIXEL = new ServerSelectionList.OnlineServerEntry(pScreen, new ServerData(SERVER_NAME, SERVER_IP, false));
    }
    ...
    public class OnlineServerEntry extends ServerSelectionList.Entry {
        ...
        private void swap(int p_99872_, int p_99873_) {
            if (this.screen.getServers().get(p_99872_).ip.equals(HYPIXEL.getServerData().ip) || this.screen.getServers().get(p_99873_).ip.equals(HYPIXEL.getServerData().ip)) {
                return;
            }
