...
public class EditServerScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.addRenderableWidget(CycleButton.builder(ServerData.ServerPackStatus::getName).a(ServerData.ServerPackStatus.values()).withInitialValue(this.serverData.getResourcePackStatus()).create(this.width / 2 - 100, this.height / 4 + 72, 200, 20, new TranslatableComponent("addServer.resourcePack"), (p_169299_, p_169300_) ->
        {
