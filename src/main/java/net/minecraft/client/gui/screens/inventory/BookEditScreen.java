...
public class BookEditScreen extends Screen
{
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        else
        {
            ...
            this.a(bookeditscreen$displaycache.selection);
    ...
    private void a(Rect2i[] p_98139_)
    {
    ...
    static int a(int[] p_98150_, int p_98151_)
    {
    ...
    static class DisplayCache
    {
        ...
        {
            int i = BookEditScreen.a(this.lineStarts, p_98211_);
            int j = i + p_98212_;
            int k;
        ...
        {
            int i = BookEditScreen.a(this.lineStarts, p_98209_);
            return this.lineStarts[i];
        }

        public int findLineEnd(int p_98219_)
        {
            int i = BookEditScreen.a(this.lineStarts, p_98219_);
