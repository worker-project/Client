    ...
    private boolean handleChunkDebugKeys(int p_167814_)
    {
        switch (p_167814_)
        {
            ...
            case 76:
                ...
                this.c("SmartCull: {0}", this.minecraft.smartCull ? "enabled" : "disabled");
                return true;
            ...
            case 86:
                ...
                this.c("ChunkVisibility: {0}", this.minecraft.chunkVisibility ? "enabled" : "disabled");
                return true;

            case 87:
                this.minecraft.wireframe = !this.minecraft.wireframe;
                this.c("WireFrame: {0}", this.minecraft.wireframe ? "enabled" : "disabled");
                return true;
        ...
        else
        {
            switch (pKey)
            {
                ...
                case 66:
                    ...
                    this.a(flag ? "debug.show_hitboxes.on" : "debug.show_hitboxes.off");
                    return true;
                ...
                case 71:
                    ...
                    this.a(flag1 ? "debug.chunk_boundaries.on" : "debug.chunk_boundaries.off");
                    return true;

                case 72:
                    this.minecraft.options.advancedItemTooltips = !this.minecraft.options.advancedItemTooltips;
                    this.a(this.minecraft.options.advancedItemTooltips ? "debug.advanced_tooltips.on" : "debug.advanced_tooltips.off");
                ...
                case 80:
                    ...
                    this.minecraft.options.save();
                    this.a(this.minecraft.options.pauseOnLostFocus ? "debug.pause_focus.on" : "debug.pause_focus.off");
                    return true;
                ...
                case 86:
                    ...
                    TextComponent textcomponent = new TextComponent(I18n.a("of.message.loadingVisibleChunks"));
