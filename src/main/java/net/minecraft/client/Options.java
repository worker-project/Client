...
public class Options
{
    ...
    private void processOptions(Options.FieldAccess p_168428_)
    {
        ...
        this.disclaimerAccepted = p_168428_.process("disclaimerAccepted", this.disclaimerAccepted);
    ...
    {
        String s = I18n.a(par1EnumOptions.getResourceKey()) + ": ";
        ...
        if (par1EnumOptions == Option.RENDER_DISTANCE)
        {
            ...
            String s2 = I18n.a("of.options.renderDistance.tiny");
            int i = 2;

            if (j1 >= 4)
            {
                s2 = I18n.a("of.options.renderDistance.short");
                i = 4;
            }

            if (j1 >= 8)
            {
                s2 = I18n.a("of.options.renderDistance.normal");
                i = 8;
            }

            if (j1 >= 16)
            {
                s2 = I18n.a("of.options.renderDistance.far");
                i = 16;
            }
        ...
        else if (par1EnumOptions == Option.FRAMERATE_LIMIT)
        {
            ...
            {
                return d1 == Option.FRAMERATE_LIMIT.getMaxValue() ? s + I18n.a("options.framerateLimit.max") : s + (int)d1 + " fps";
            }
        }
        ...
        else if (par1EnumOptions instanceof ProgressOption)
        {
            ...
            return d0 == 0.0D ? s + I18n.a("options.off") : s + (int)(d0 * 100.0D) + "%";
        }
        else
        {
            return null;
    ...
    public String dumpOptionsForReport()
    {
        ...
        return immutablelist.stream().map((p_168421_0_) ->
        {
            return (String)p_168421_0_.getFirst() + ": " + (String)p_168421_0_.getSecond();
