...
public class SpiderModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    public SpiderModel(ModelPart pRoot)
    {
        ...
        this.rightMiddleHindLeg = pRoot.getChilds("right_middle_hind_leg");
        this.leftMiddleHindLeg = pRoot.getChilds("left_middle_hind_leg");
        this.rightMiddleFrontLeg = pRoot.getChilds("right_middle_front_leg");
        this.leftMiddleFrontLeg = pRoot.getChilds("left_middle_front_leg");
