...
public class BoatModel extends ListModel<Boat>
{
    ...
    {
        this.leftPaddle = pRoot.getChilds("left_paddle");
        this.rightPaddle = pRoot.getChilds("right_paddle");
        this.waterPatch = pRoot.getChilds("water_patch");
        this.parts = ImmutableList.of(pRoot.getChilds("bottom"), pRoot.getChilds("back"), pRoot.getChilds("front"), pRoot.getChilds("right"), pRoot.getChilds("left"), this.leftPaddle, this.rightPaddle);
    }
