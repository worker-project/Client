...
public class WitherBossModel<T extends WitherBoss> extends HierarchicalModel<T>
{
    ...
    {
        this.root = pRoot;
        this.ribcage = pRoot.getChilds("ribcage");
        this.tail = pRoot.getChilds("tail");
        this.centerHead = pRoot.getChilds("center_head");
        this.rightHead = pRoot.getChilds("right_head");
        this.leftHead = pRoot.getChilds("left_head");
    }
