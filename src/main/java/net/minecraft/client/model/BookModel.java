...
public class BookModel extends Model
{
    ...
    public BookModel(ModelPart pRoot)
    {
        ...
        this.root = pRoot;
        this.leftLid = pRoot.getChilds("left_lid");
        this.rightLid = pRoot.getChilds("right_lid");
        this.leftPages = pRoot.getChilds("left_pages");
        this.rightPages = pRoot.getChilds("right_pages");
        this.flipPage1 = pRoot.getChilds("flip_page1");
        this.flipPage2 = pRoot.getChilds("flip_page2");
    }
