...
public class CreeperModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    public CreeperModel(ModelPart pRoot)
    {
        ...
        this.leftHindLeg = pRoot.getChilds("right_hind_leg");
        this.rightHindLeg = pRoot.getChilds("left_hind_leg");
        this.leftFrontLeg = pRoot.getChilds("right_front_leg");
        this.rightFrontLeg = pRoot.getChilds("left_front_leg");
    }
