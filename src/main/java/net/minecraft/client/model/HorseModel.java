...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T>
{
    ...
    public HorseModel(ModelPart pRoot)
    {
        ...
        this.headParts = pRoot.getChilds("head_parts");
        ...
        this.rightHindBabyLeg = pRoot.getChilds("right_hind_baby_leg");
        this.leftHindBabyLeg = pRoot.getChilds("left_hind_baby_leg");
        this.rightFrontBabyLeg = pRoot.getChilds("right_front_baby_leg");
        this.leftFrontBabyLeg = pRoot.getChilds("left_front_baby_leg");
    ...
    public static MeshDefinition createBodyMesh(CubeDeformation pCubeDeformation)
    {
        ...
        partdefinition2.addOrReplaceChild("left_saddle_line", CubeListBuilder.create().texOffs(32, 2).addBox(3.1F, -6.0F, -8.0F, 0.0F, 3.0F, 16.0F, pCubeDeformation), PartPose.rotation((-(float)Math.PI / 6F), 0.0F, 0.0F));
        partdefinition2.addOrReplaceChild("right_saddle_line", CubeListBuilder.create().texOffs(32, 2).addBox(-3.1F, -6.0F, -8.0F, 0.0F, 3.0F, 16.0F, pCubeDeformation), PartPose.rotation((-(float)Math.PI / 6F), 0.0F, 0.0F));
