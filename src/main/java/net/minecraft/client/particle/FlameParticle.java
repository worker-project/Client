...
public class FlameParticle extends RisingParticle
{
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType>
    {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double p_172127_, double pY, double p_172129_, double pZ, double p_172131_)
        {
            FlameParticle flameparticle = new FlameParticle(pLevel, pX, p_172127_, pY, p_172129_, pZ, p_172131_);
            flameparticle.pickSprite(this.sprite);
