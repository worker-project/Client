        ...
        else
        {
            ...
            for (GameEventListenerRenderer.TrackedListener gameeventlistenerrenderer$trackedlistener : this.trackedListeners)
            {
                gameeventlistenerrenderer$trackedlistener.getPosition(level).ifPresent((p_173858_) ->
                {
                    ...
                    LevelRenderer.renderVoxelShape(pPoseStack, vertexconsumer, Shapes.create(new AABB((double)i, (double)j, (double)k, (double)l, (double)i1, (double)j1)), -pCamX, -p_173849_, -pCamY, vector3f.x(), vector3f.y(), vector3f.z(), 0.35F);
                });
            }
