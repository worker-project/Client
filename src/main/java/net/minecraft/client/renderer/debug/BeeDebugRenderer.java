...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pPoseStack, MultiBufferSource pBufferSource, double pCamX, double p_113064_, double pCamY)
    {
    ...
    public static class BeeInfo
    {
        ...
        public BeeInfo(UUID pUuid, int pId, Position pPos, Path pPath, BlockPos pHivePos, BlockPos pFlowerPos, int pTravelTicks)
        {
            this.uuid = pUuid;
            this.id = pId;
            this.pos = pPos;
