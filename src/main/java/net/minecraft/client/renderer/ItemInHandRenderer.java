...
public class ItemInHandRenderer
{
    ...
    public void renderHandsWithItems(float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource.BufferSource pBuffer, LocalPlayer pPlayerEntity, int pCombinedLight)
    {
        ...
        if (iteminhandrenderer$handrenderselection.renderMainHand)
        {
            ...
            if (!Reflector.ForgeHooksClient_renderSpecificFirstPersonHand.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_renderSpecificFirstPersonHand, InteractionHand.MAIN_HAND, pMatrixStack, pBuffer, pCombinedLight, pPartialTicks, f1, f4, f5, this.mainHandItem))
            {
