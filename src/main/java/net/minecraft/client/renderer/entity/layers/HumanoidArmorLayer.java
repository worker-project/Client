        ...
        if (itemstack.getItem() instanceof ArmorItem)
        {
            ...
            if (armoritem.getSlot() == p_117122_)
            {
                ...
                if (armoritem instanceof DyeableLeatherItem)
                {
                    ...
                    this.renderModel(p_117119_, p_117120_, p_117123_, flag, model, f, f1, f2, this.getArmorResource(p_117121_, itemstack, p_117122_, (String)null));
                ...
                {
                    this.renderModel(p_117119_, p_117120_, p_117123_, flag, model, 1.0F, 1.0F, 1.0F, this.getArmorResource(p_117121_, itemstack, p_117122_, (String)null));
                }
            }
        }
    }
