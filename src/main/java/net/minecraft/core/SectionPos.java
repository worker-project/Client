...
public class SectionPos extends Vec3i
{
    ...
    public static SectionPos of(Entity pPos)
    {
        return new SectionPos(blockToSectionCoord(pPos.getBlockX()), blockToSectionCoord(pPos.getBlockY()), blockToSectionCoord(pPos.getBlockZ()));
    }

    public static SectionPos of(long pPos)
    {
        return new SectionPos(x(pPos), y(pPos), z(pPos));
    }
