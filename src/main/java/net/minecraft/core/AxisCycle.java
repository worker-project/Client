...
public enum AxisCycle
{
    ...
    public abstract int cycle(int pX, int p_121795_, int pY, Direction.Axis p_121797_);

    public abstract double cycle(double pX, double p_175237_, double pY, Direction.Axis p_175239_);
