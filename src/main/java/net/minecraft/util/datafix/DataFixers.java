...
public class DataFixers
{
    ...
    private static void addFixers(DataFixerBuilder pBuilder)
    {
        ...
        pBuilder.addFixer(new ChunkBedBlockEntityInjecterFix(schema33, true));
        ...
        pBuilder.addFixer(new WeaponSmithChestLootTableFix(schema81, false));
        Schema schema82 = pBuilder.addSchema(1917, SAME_NAMESPACED);
        pBuilder.addFixer(new CatTypeFix(schema82, false));
        Schema schema83 = pBuilder.addSchema(1918, SAME_NAMESPACED);
        pBuilder.addFixer(new VillagerDataFix(schema83, "minecraft:villager"));
        pBuilder.addFixer(new VillagerDataFix(schema83, "minecraft:zombie_villager"));
        Schema schema84 = pBuilder.addSchema(1920, V1920::new);
        pBuilder.addFixer(new NewVillageFix(schema84, false));
        pBuilder.addFixer(new AddNewChoices(schema84, "Add campfire", References.BLOCK_ENTITY));
        Schema schema85 = pBuilder.addSchema(1925, SAME_NAMESPACED);
        pBuilder.addFixer(new MapIdFix(schema85, false));
        Schema schema86 = pBuilder.addSchema(1928, V1928::new);
        pBuilder.addFixer(new EntityRavagerRenameFix(schema86, true));
        pBuilder.addFixer(ItemRenameFix.create(schema86, "Rename ravager egg item", createRenamer(EntityRavagerRenameFix.RENAMED_IDS)));
        Schema schema87 = pBuilder.addSchema(1929, V1929::new);
        pBuilder.addFixer(new AddNewChoices(schema87, "Add Wandering Trader and Trader Llama", References.ENTITY));
        Schema schema88 = pBuilder.addSchema(1931, V1931::new);
        pBuilder.addFixer(new AddNewChoices(schema88, "Added Fox", References.ENTITY));
        Schema schema89 = pBuilder.addSchema(1936, SAME_NAMESPACED);
        pBuilder.addFixer(new OptionsAddTextBackgroundFix(schema89, false));
        Schema schema90 = pBuilder.addSchema(1946, SAME_NAMESPACED);
        pBuilder.addFixer(new ReorganizePoi(schema90, false));
        Schema schema91 = pBuilder.addSchema(1948, SAME_NAMESPACED);
        pBuilder.addFixer(new OminousBannerRenameFix(schema91, false));
        Schema schema92 = pBuilder.addSchema(1953, SAME_NAMESPACED);
        pBuilder.addFixer(new OminousBannerBlockEntityRenameFix(schema92, false));
        Schema schema93 = pBuilder.addSchema(1955, SAME_NAMESPACED);
        pBuilder.addFixer(new VillagerRebuildLevelAndXpFix(schema93, false));
        pBuilder.addFixer(new ZombieVillagerRebuildXpFix(schema93, false));
        Schema schema94 = pBuilder.addSchema(1961, SAME_NAMESPACED);
        pBuilder.addFixer(new ChunkLightRemoveFix(schema94, false));
        Schema schema95 = pBuilder.addSchema(1963, SAME_NAMESPACED);
        pBuilder.addFixer(new RemoveGolemGossipFix(schema95, false));
        Schema schema96 = pBuilder.addSchema(2100, V2100::new);
        pBuilder.addFixer(new AddNewChoices(schema96, "Added Bee and Bee Stinger", References.ENTITY));
        pBuilder.addFixer(new AddNewChoices(schema96, "Add beehive", References.BLOCK_ENTITY));
        pBuilder.addFixer(new RecipesRenameFix(schema96, false, "Rename sugar recipe", createRenamer("minecraft:sugar", "sugar_from_sugar_cane")));
        pBuilder.addFixer(new AdvancementsRenameFix(schema96, false, "Rename sugar recipe advancement", createRenamer("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        Schema schema97 = pBuilder.addSchema(2202, SAME_NAMESPACED);
        pBuilder.addFixer(new ChunkBiomeFix(schema97, false));
        Schema schema98 = pBuilder.addSchema(2209, SAME_NAMESPACED);
        pBuilder.addFixer(ItemRenameFix.create(schema98, "Rename bee_hive item to beehive", createRenamer("minecraft:bee_hive", "minecraft:beehive")));
        pBuilder.addFixer(new BeehivePoiRenameFix(schema98));
        pBuilder.addFixer(BlockRenameFix.create(schema98, "Rename bee_hive block to beehive", createRenamer("minecraft:bee_hive", "minecraft:beehive")));
        Schema schema99 = pBuilder.addSchema(2211, SAME_NAMESPACED);
        pBuilder.addFixer(new StructureReferenceCountFix(schema99, false));
        Schema schema100 = pBuilder.addSchema(2218, SAME_NAMESPACED);
        pBuilder.addFixer(new ForcePoiRebuild(schema100, false));
        Schema schema101 = pBuilder.addSchema(2501, V2501::new);
        pBuilder.addFixer(new FurnaceRecipeFix(schema101, true));
        Schema schema102 = pBuilder.addSchema(2502, V2502::new);
        pBuilder.addFixer(new AddNewChoices(schema102, "Added Hoglin", References.ENTITY));
        Schema schema103 = pBuilder.addSchema(2503, SAME_NAMESPACED);
        pBuilder.addFixer(new WallPropertyFix(schema103, false));
        pBuilder.addFixer(new AdvancementsRenameFix(schema103, false, "Composter category change", createRenamer("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        Schema schema104 = pBuilder.addSchema(2505, V2505::new);
        pBuilder.addFixer(new AddNewChoices(schema104, "Added Piglin", References.ENTITY));
        pBuilder.addFixer(new MemoryExpiryDataFix(schema104, "minecraft:villager"));
        Schema schema105 = pBuilder.addSchema(2508, SAME_NAMESPACED);
        pBuilder.addFixer(ItemRenameFix.create(schema105, "Renamed fungi items to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        pBuilder.addFixer(BlockRenameFix.create(schema105, "Renamed fungi blocks to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        Schema schema106 = pBuilder.addSchema(2509, V2509::new);
        pBuilder.addFixer(new EntityZombifiedPiglinRenameFix(schema106));
        pBuilder.addFixer(ItemRenameFix.create(schema106, "Rename zombie pigman egg item", createRenamer(EntityZombifiedPiglinRenameFix.RENAMED_IDS)));
        Schema schema107 = pBuilder.addSchema(2511, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityProjectileOwnerFix(schema107));
        Schema schema108 = pBuilder.addSchema(2514, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityUUIDFix(schema108));
        pBuilder.addFixer(new BlockEntityUUIDFix(schema108));
        pBuilder.addFixer(new PlayerUUIDFix(schema108));
        pBuilder.addFixer(new LevelUUIDFix(schema108));
        pBuilder.addFixer(new SavedDataUUIDFix(schema108));
        pBuilder.addFixer(new ItemStackUUIDFix(schema108));
        Schema schema109 = pBuilder.addSchema(2516, SAME_NAMESPACED);
        pBuilder.addFixer(new GossipUUIDFix(schema109, "minecraft:villager"));
        pBuilder.addFixer(new GossipUUIDFix(schema109, "minecraft:zombie_villager"));
        Schema schema110 = pBuilder.addSchema(2518, SAME_NAMESPACED);
        pBuilder.addFixer(new JigsawPropertiesFix(schema110, false));
        pBuilder.addFixer(new JigsawRotationFix(schema110, false));
        Schema schema111 = pBuilder.addSchema(2519, V2519::new);
        pBuilder.addFixer(new AddNewChoices(schema111, "Added Strider", References.ENTITY));
        Schema schema112 = pBuilder.addSchema(2522, V2522::new);
        pBuilder.addFixer(new AddNewChoices(schema112, "Added Zoglin", References.ENTITY));
        Schema schema113 = pBuilder.addSchema(2523, SAME_NAMESPACED);
        pBuilder.addFixer(new AttributesRename(schema113));
        Schema schema114 = pBuilder.addSchema(2527, SAME_NAMESPACED);
        pBuilder.addFixer(new BitStorageAlignFix(schema114));
        Schema schema115 = pBuilder.addSchema(2528, SAME_NAMESPACED);
        pBuilder.addFixer(ItemRenameFix.create(schema115, "Rename soul fire torch and soul fire lantern", createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        pBuilder.addFixer(BlockRenameFix.create(schema115, "Rename soul fire torch and soul fire lantern", createRenamer(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        Schema schema116 = pBuilder.addSchema(2529, SAME_NAMESPACED);
        pBuilder.addFixer(new StriderGravityFix(schema116, false));
        Schema schema117 = pBuilder.addSchema(2531, SAME_NAMESPACED);
        pBuilder.addFixer(new RedstoneWireConnectionsFix(schema117));
        Schema schema118 = pBuilder.addSchema(2533, SAME_NAMESPACED);
        pBuilder.addFixer(new VillagerFollowRangeFix(schema118));
        Schema schema119 = pBuilder.addSchema(2535, SAME_NAMESPACED);
        pBuilder.addFixer(new EntityShulkerRotationFix(schema119));
        ...
        pBuilder.addFixer(new RenameBiomesFix(schema122, false, "Nether biome rename", ImmutableMap.of("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema123 = pBuilder.addSchema(2553, SAME_NAMESPACED);
        pBuilder.addFixer(new BiomeFix(schema123, false));
        ...
        pBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema128, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        pBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema132, "Renamed copper blocks to new oxidized terms", createRenamer(immutablemap)));
        ...
        pBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema133, "Rename copper blocks suffixes", createRenamer(immutablemap1)));
        ...
        pBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema135, "Renamed grimstone blocks to deepslate", createRenamer(immutablemap2)));
        Schema schema136 = pBuilder.addSchema(2700, SAME_NAMESPACED);
        pBuilder.addFixer(BlockRenameFixWithJigsaw.create(schema136, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        pBuilder.addFixer(new StatsRenameFix(schema141, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
        Schema schema142 = pBuilder.addSchema(2717, SAME_NAMESPACED);
        pBuilder.addFixer(ItemRenameFix.create(schema142, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        pBuilder.addFixer(BlockRenameFix.create(schema142, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        ...
        pBuilder.addFixer(new RenameBiomesFix(schema147, false, "Caves and Cliffs biome renames", CavesAndCliffsRenames.RENAMES));
    ...
    private static UnaryOperator<String> createRenamer(Map<String, String> pRenameMap)
    {
        return (p_14528_) ->
        {
            return pRenameMap.getOrDefault(p_14528_, p_14528_);
        };
    }
