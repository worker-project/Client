            ...
            try
            {
                while (true)
                {
                    ...
                    if (10 <= i)
                    {
                        ...
                        j += 4;
                        int l = PktUtils.b(this.buf, j, i);
                        j += 4;
                        int i1 = PktUtils.a(this.buf, j);
                        j += 4;
                        ...
                        switch (i1)
                        {
                            case 2:
                                if (this.authed)
                                {
                                    String s1 = PktUtils.a(this.buf, j, i);
                            ...
                            case 3:
                                String s = PktUtils.a(this.buf, j, i);
                                int j1 = j + s.length();
