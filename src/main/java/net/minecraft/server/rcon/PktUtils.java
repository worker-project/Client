...
public class PktUtils
{
    ...
    public static String a(byte[] p_11489_, int p_11490_, int p_11491_)
    {
        int i = p_11491_ - 1;
        int j;
    ...
    public static int a(byte[] p_11486_, int p_11487_)
    {
        return b(p_11486_, p_11487_, p_11486_.length);
    }

    public static int b(byte[] p_11493_, int p_11494_, int p_11495_)
    {
    ...
    public static int c(byte[] p_11497_, int p_11498_, int p_11499_)
    {
