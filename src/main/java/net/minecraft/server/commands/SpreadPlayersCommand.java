...
public class SpreadPlayersCommand
{
    ...
    private static int spreadPlayers(CommandSourceStack p_138703_, Vec2 p_138704_, float p_138705_, float p_138706_, int p_138707_, boolean p_138708_, Collection <? extends Entity > p_138709_) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            a(p_138704_, (double)p_138705_, serverlevel, random, d0, d1, d2, d3, p_138707_, aspreadplayerscommand$position, p_138708_);
            double d4 = a(p_138709_, serverlevel, aspreadplayerscommand$position, p_138707_, p_138708_);
    ...
    private static void a(Vec2 p_138711_, double p_138712_, ServerLevel p_138713_, Random p_138714_, double p_138715_, double p_138716_, double p_138717_, double p_138718_, int p_138719_, SpreadPlayersCommand.Position[] p_138720_, boolean p_138721_) throws CommandSyntaxException
    {
        boolean flag = true;
    ...
    private static double a(Collection <? extends Entity > p_138730_, ServerLevel p_138731_, SpreadPlayersCommand.Position[] p_138732_, int p_138733_, boolean p_138734_)
    {
        double d0 = 0.0D;
        int i = 0;
