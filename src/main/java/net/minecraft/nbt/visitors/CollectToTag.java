...
public class CollectToTag implements StreamTagVisitor
{
    ...
    public StreamTagVisitor.ValueResult a(byte[] p_197695_)
    {
        this.appendEntry(new ByteArrayTag(p_197695_));
        return StreamTagVisitor.ValueResult.CONTINUE;
    }

    public StreamTagVisitor.ValueResult a(int[] p_197697_)
    {
        this.appendEntry(new IntArrayTag(p_197697_));
        return StreamTagVisitor.ValueResult.CONTINUE;
    }

    public StreamTagVisitor.ValueResult a(long[] p_197699_)
    {
