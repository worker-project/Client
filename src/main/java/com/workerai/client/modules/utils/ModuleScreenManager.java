...
public class ModuleScreenManager {
    ...
    public static void drawBackground(PoseStack pPoseStack, Screen pScreen, Component pTitle) {
        GuiComponent.fill(pPoseStack, (pScreen.width / 2) - 121, (pScreen.height / 2) - 78, (pScreen.width / 2) + 121, (pScreen.height / 2) + 78, CUSTOM_YELLOW);
        GuiComponent.fill(pPoseStack, (pScreen.width / 2) - 120, (pScreen.height / 2) - 77, (pScreen.width / 2) + 120, (pScreen.height / 2) + 77, CUSTOM_LIGHT_GRAY);
        GuiComponent.fill(pPoseStack, (pScreen.width / 2) - 110, (pScreen.height / 2) - 57, (pScreen.width / 2) + 110, (pScreen.height / 2) + 67, CUSTOM_DARK_GRAY);
