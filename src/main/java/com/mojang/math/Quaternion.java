...
public final class Quaternion
{
    ...
    public Quaternion(float pI, float pJ, float pK, boolean pR)
    {
        if (pR)
        {
            pI *= ((float)Math.PI / 180F);
            pJ *= ((float)Math.PI / 180F);
            pK *= ((float)Math.PI / 180F);
        }

        float f = sin(0.5F * pI);
        float f1 = cos(0.5F * pI);
        float f2 = sin(0.5F * pJ);
        float f3 = cos(0.5F * pJ);
        float f4 = sin(0.5F * pK);
        float f5 = cos(0.5F * pK);
