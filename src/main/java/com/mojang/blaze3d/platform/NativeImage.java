...
public final class NativeImage implements AutoCloseable
{
    ...
    {
        this(NativeImage.Format.RGBA, pFormat, pWidth, pHeight);
    }
    ...
    public static NativeImage read(@Nullable NativeImage.Format pFormat, ByteBuffer pTextureStream) throws IOException
    {
        if (pFormat != null && !pFormat.supportedByStb())
        {
            throw new UnsupportedOperationException("Don't know how to read format " + pFormat);
        }
        else if (MemoryUtil.memAddress(pTextureStream) == 0L)
        {
        ...
        else
        {
            ...
            try
            {
                ...
                ByteBuffer bytebuffer = STBImage.stbi_load_from_memory(pTextureStream, intbuffer, intbuffer1, intbuffer2, pFormat == null ? 0 : pFormat.components);
