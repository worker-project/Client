...
public class InputConstants
{
    ...
    public static final InputConstants.Key bv;
    ...
    public static void setupKeyboardCallbacks(long pWindow, GLFWKeyCallbackI p_84846_, GLFWCharModsCallbackI pKeyCallback)
    {
        ...
        GLFW.glfwSetCharModsCallback(pWindow, pKeyCallback);
    }

    public static void setupMouseCallbacks(long pWindow, GLFWCursorPosCallbackI p_84840_, GLFWMouseButtonCallbackI pCursorPositionCallback, GLFWScrollCallbackI pMouseButtonCallback, GLFWDropCallbackI pScrollCallback)
    {
        GLFW.glfwSetCursorPosCallback(pWindow, p_84840_);
        GLFW.glfwSetMouseButtonCallback(pWindow, pCursorPositionCallback);
        GLFW.glfwSetScrollCallback(pWindow, pMouseButtonCallback);
        GLFW.glfwSetDropCallback(pWindow, pScrollCallback);
    }

    public static void grabOrReleaseMouse(long pWindow, int p_84835_, double pCursorValue, double pXPos)
    {
        GLFW.glfwSetCursorPos(pWindow, pCursorValue, pXPos);
        GLFW.glfwSetInputMode(pWindow, 208897, p_84835_);
    }
    ...
    public static void updateRawMouseInput(long pWindow, boolean p_84850_)
    {
        if (isRawMouseInputSupported())
        {
            GLFW.glfwSetInputMode(pWindow, GLFW_RAW_MOUSE_MOTION, p_84850_ ? 1 : 0);
        }
    }
    ...
    static
    {
        ...
        bv = InputConstants.Type.KEYSYM.getOrCreate(-1);
    }
